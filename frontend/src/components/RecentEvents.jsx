    ...
    <div className="glass-card p-6">
      ...
      <div className="space-y-2 max-h-80 overflow-y-auto">
        {events.map((event, i) => (
          <div
            key={i}
            className="flex items-center justify-between p-3 rounded-lg bg-sentinel-dark/50 border border-sentinel-border hover:border-blue-500/20 transition-all"
          >
            <div className="flex items-center gap-3">
              {type === 'login' ? (
                ...
                <>
                  <div className={`w-2.5 h-2.5 rounded-full ${
                    event.risk_detected ? 'bg-red-500' : 'bg-emerald-500'
                  }`} />
                  <div>
